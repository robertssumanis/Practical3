...
import { StyleSheet, ActivityIndicator, View, Text, ScrollView, Dimensions, TouchableOpacity } from "react-native";
...
function MapScreen() {
  return (
    <View style={styles.container}>
      <MapView style={styles.map}  showsUserLocation={true} followsUserLocation />
    </View>
  );
}
